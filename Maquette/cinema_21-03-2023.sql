...
-- Listage des données de la table basile_cinema.moviegenrelist : ~13 rows (environ)
...
-- Listage des données de la table basile_cinema.news : ~4 rows (environ)
DELETE FROM `news`;
...
DELETE FROM `person`;
INSERT INTO `person` (`person_id`, `person_firstName`, `person_lastName`, `person_gender`, `person_birthDate`, `person_imgUrl`) VALUES
	(1, 'Leonardo', 'Di Caprio', 'homme', '1980-05-25', 'leonardoDiCaprio.png'),
	(2, 'Kate', 'Winslet', 'femme', '1975-08-05', 'kateWingslet.png'),
	(3, 'Billy', 'Zane', 'homme', '1925-08-05', 'billyZane.png'),
	(4, 'Stanley', 'Kubrik', 'homme', '1928-06-26', 'stanleyKubrik.png'),
	(5, 'James', 'Cameron', 'homme', '1954-05-16', 'jamesCameron.png'),
	(6, 'Matthew', 'Modine', 'homme', '1959-03-29', 'matthewModine.jpg'),
	(7, 'Adam', 'Baldwin', 'homme', '1962-02-27', 'adamBaldwin.jpg'),
	(9, 'Martin', 'Scorsese', 'homme', '1942-09-17', 'martinScorsese.png'),
	(10, 'Danny', 'Boyle', 'homme', '1956-08-20', 'dannyBoyle.jpg'),
	(11, 'Gloria', 'Stuart', 'femme', '1910-04-05', 'gloriaStuart.png'),
	(12, 'Ben', 'Kingsley', 'homme', '1971-02-02', 'benKingsley.jpg'),
	(16, 'Christoph', 'Waltz', 'homme', '1977-03-21', 'christopheWaltz.jpg'),
	(17, 'Quentin', 'Tarantino', 'homme', '2092-05-25', 'quentinTarantino.png');
